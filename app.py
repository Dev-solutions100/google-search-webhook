    ...
    if(1):            
        if(1):    
            ...
            if(cntrygot==1):        
                ...
                data3=model.predict([[days+2,cases,tests,density,rate]])
                data2=int(data2)
                data3=int(data3)
                data2=f'{data2:,}'
                data3=f'{data3:,}'
