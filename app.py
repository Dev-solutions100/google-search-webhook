                ...
                try:
                    ...
                    if(err1==0):
                        ...
                        if(i5!=''):
                            ...
                            r1="Sorry, this is *not a district*. Please *Google* the district in which your area is present and try again with the district name *only* (Ex: *Gautam Buddha Nagar*).\n\n"+emoji.emojize(':round_pushpin:', use_aliases=True)+"Reply with another *District/City/State/Country* to see its cases\n"+emoji.emojize(':round_pushpin:', use_aliases=True)+"Reply *0* for Main Menu"
                    return r1
        else:
